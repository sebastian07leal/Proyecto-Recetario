...
public class Principal extends javax.swing.JFrame {
    ...
    private Tips tips;
    private MostrarReceta mostrarReceta;
    private int ubicacion;
    private String usuariotem;
    ...
    protected void irMostrarReceta(JPanel jPanel){
        remove(jPanel);
        mostrarReceta= new MostrarReceta(this);
        mostrarReceta.setVisible(true);
        add(mostrarReceta);
        pack();
        setLocationRelativeTo(null);
    }
    public String getUsuariotem() {
        return usuariotem;
    }
    
    public void setUsuariotem(String usuariotem) {
    ...
    public void settipo(String nombrerec) {
        this.tipo = nombrerec;
    }
